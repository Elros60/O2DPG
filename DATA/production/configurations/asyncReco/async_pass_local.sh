...
#
 export ALIEN_JDL_LPMRUNNUMBER=544392
 export ALIEN_JDL_LPMINTERACTIONTYPE=PbPb
 export ALIEN_JDL_LPMPRODUCTIONTAG=LHC23zzi
 export ALIEN_JDL_LPMPASSNAME=apass2
 export ALIEN_JDL_LPMANCHORYEAR=2023
 export ALIEN_JDL_WORKFLOW_DETECTORS="ITS,MFT,MCH,MID,CTP,FV0,FT0"
 export ALIEN_JDL_ALIGNRECORD_CONF="--fix-chamber 1,6 --fitter-config pp"

export ALIEN_JDL_CPUCORES=10
export ALIEN_JDL_TFDELAYSECONDS=1
